...
<div class="workspaces view content">
    <?php if($workspace->categories !== null) :?>
        ...
        <ul id="categories" class="d-flex justify-content-between flex-wrap ps-0 ">
            <?php foreach ($workspace->categories as $categories) : ?>
                <li class="card w-25 m-2">   
                    <div style="background-color:<?= h($categories->color)?>" class="card-img-top border-bottom mb-3"></div>
                                ...
                                <section class="card-body">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <?php if($cards->manager !== null):?>
                                            <p class="card-text text-secondary">Manager : <?= h($cards->manager) ?></p>
                                        <?php endif?>
                                    </div>
        ...
        <div 
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <a class="text-start" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <?= __('Related Logs') ?>
                </a>
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        <?=$workspace->logs?>
                        <?=var_dump($workspace->logs)?>
                    </div>
                </div>

                <p class="mt-3">Member list</p>
        ...
        <div class="modal-content">
            ...
            <section class="modal-footer justify-content-between">
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <p class="text-secondary mb-0 me-3">Author : <?= h($cards->creator)?></p>
...
<div class="modal fade" id="CardEditModal" tabindex="-1" aria-labelledby="CardEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <?= $this->Form->create($editCards, ['url' => ['controller' => 'Cards', 'action' => 'edit']]) ?>
            <div class="modal-header">
